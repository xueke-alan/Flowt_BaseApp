<template>
  <n-layout class="layout" :position="fixedMenu" has-sider content-style="overflow:hidden">
    ...
    <n-layout :inverted="inverted" :content-style="{ overflow: 'hidden' }">
      ...
      <n-layout class="layout-content" id="layout-content-main" :content-style="{
        ...
        <n-watermark :content="watermarkContent" cross selectable :font-size="16" :line-height="16" :width="250"
          :height="250" font-color="rgba(128,128,128,0.1)" :x-offset="12" :y-offset="100" :rotate="-15"
          style="height: 100%">
...
.layout {
  ...
  .vison {
    ...
    .num {
      max-width: 90px;
      transition: max-width 0.5s var(--n-bezier) 0.3s;
      overflow: hidden;
      white-space: nowrap;
